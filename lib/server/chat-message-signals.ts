...
const professionalActionPattern = /(?:承担|负责|交付|开发|接手|保证|验证|回滚|部署|上线|迭代|依据|转成|实现|设计|优化|解决|协作|复盘|分析|评估|搭建|改进|应对|判断|执行|追问|确认|拒绝)/iu;
const genericKnowledgeQuestionPattern = /^(?:请问)?(?:什么是|什么叫|是什么意思|指什么|怎么理解)[^?？]{0,80}[?？。！!]*$|^[^?？]{1,80}(?:是什么|是指什么)[?？。！!]*$/iu;
