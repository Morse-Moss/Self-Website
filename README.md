...
- 当前仍不标记 `ONLINE_READY`：生产 Lighthouse 性能分数尚未复测，监控、托管备份、edge 速率/连接限制及真实 Bocha/Feishu smoke 仍待完成；工作区中另一条尚未提交的数字摩斯简介、新版主图、六主题知识及配套样式、测试与素材未进入 `b15be68`，也未复制到服务器。
